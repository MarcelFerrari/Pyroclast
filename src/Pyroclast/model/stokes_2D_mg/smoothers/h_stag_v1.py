...
File: Pyroclast/model/stokes_2D_mg/smoothers/h_stag_v1.py 
Description: Internal If implementation of staggered red-black gauss-seidel
        ...
        for i in nb.prange(1, ny1 - 1 + 2):
            if 1 <= i < ny1 - 1:
                ...
                for j in range(j_start, nx1 - 2, 2):
                    ...
                    vy_c1, vy_c2, vy_c3, vy_c4, vy_c5, vx_c1, vx_c2, vx_c3, vx_c4 = vy_op.compute_coeffs(i, j, dx, dy, etap, etab)

                    vy[i, j] = vy_op.compute_neighbor_sum(i=i, j=j, relax_v=relax_v,
            ...
            if 1 <= i - 2 <= ny1 - 1:
                ...
                for j in range(j_start, nx1 - 2, 2):
                    ...
                    vy_c1, vy_c2, vy_c3, vy_c4, vy_c5, vx_c1, vx_c2, vx_c3, vx_c4 = vy_op.compute_coeffs(i - 2, j, dx, dy, etap, etab)

                    vy[i - 2, j] = vy_op.compute_neighbor_sum(i=i - 2, j=j, relax_v=relax_v,
                                                              vx=vx, vy=vy, rhs=vy_rhs,
                                                              vy_c1=vy_c1, vy_c2=vy_c2, vy_c3=vy_c3, vy_c4=vy_c4, vy_c5=vy_c5,
                                                              vx_c1=vx_c1, vx_c2=vx_c2, vx_c3=vx_c3, vx_c4=vx_c4)
