...
File: Pyroclast/model/stokes_2D_mg/smoothers/vy/inline_vx_rb_gs.py 
Description: File contains basic red-black Gauss-Seidel smoother for vy array with inlined loop body.
...
from Pyroclast.model.stokes_2D_mg.smoothers.vy.inline_vy import compute_coeffs, compute_neighbor_sum
