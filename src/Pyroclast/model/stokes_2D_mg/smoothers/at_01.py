...
File: Pyroclast/model/stokes_2D_mg/smoothers/at_01.py
Description: Attempt 1: Reimplement the fully staggered loop with correct staggering. And Thread Blocking
