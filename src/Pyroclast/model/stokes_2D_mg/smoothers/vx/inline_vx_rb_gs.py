...
File: Pyroclast/model/stokes_2D_mg/smoothers/vx/inline_vx_rb_gs.py
Description: File contains red-black Guass-Seidel pass for vx only, with the loop body being being a separate 
             function with inline="always" to check if numba correctly inlines and compiles the calls.
