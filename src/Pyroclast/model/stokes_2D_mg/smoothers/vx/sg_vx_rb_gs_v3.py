...
"""
In this file we aim to test if the staggered approach with explicit setup of the pipeline and explicit tear down of the 
pipeline is faster than compiling an if into the the for loop.
"""
...
def _vx_rb_gs_sweep(nx1, ny1,
    ...
    # INFO: Staggered Loop Passes with Thread Blocking
