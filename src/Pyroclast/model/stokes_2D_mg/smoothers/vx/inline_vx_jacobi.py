...
File: Pyroclast/model/stokes_2D_mg/smoothers/vx/inline_vx_jacobi.py
Description: File contians jacobi vx smoother with inlined loop body
...
from ._inline_vx import cpu_compute_coeffs_vx, compute_neighbor_sum
