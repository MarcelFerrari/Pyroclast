...
File: Pyroclast/model/stoked_2D_mg/smoothers/vx/sg_vx_rb_gs_v1.py
Description: In this file we aim to test if the staggered approach to red-black gauss seidel is faster than the 
             regular approach. We consider this a success if it is as fast as the non-staggered approach
