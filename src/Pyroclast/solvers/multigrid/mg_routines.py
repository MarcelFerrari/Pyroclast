...
def restrict_2D_serial(nxh: int, nyh: int, xh: np.ndarray, yh: np.ndarray, uh: np.ndarray,
...
def restrict_2D(nxh: int, nyh: int, xh: np.ndarray, yh: np.ndarray, uh: np.ndarray,
    ...
    if th > nyH - 1:
        return restrict_2D_serial(nxh=nxh, nyh=nyh, xh=xh, yh=yh, uh=uh,
                                  nxH=nxH, nyH=nyH, xH=xH, yH=yH, uH=uH, uHw=uHw)
