...
class CircularInclusion(RK42DStokes):
    """
...
class RectangularInclusion(RK42DStokes):
    """
    Circular inclusion in 2D.
    """
    def __init__(self, ctx):
...
@nb.njit(cache=True)
def _init_rectangular_inclusion(nmx, nmy, dxm, dym, x0, y0, w, h, xm, ym, rho_plume, rho_mantle, eta_plume, eta_mantle, rhom, etam):
    """
    Initialize the material properties of the markers.
